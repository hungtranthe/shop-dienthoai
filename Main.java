...
public class Main {
    public static void main(String[] args) {
        ...
        DSHoaDon dshd = new DSHoaDon(100,"hoadon.dat"); // Khởi tạo danh sách hóa đơn với kích thước tối đa là 100
        // DSChiTietHoaDon dscthd = new DSChiTietHoaDon(dsdt, 100,"DSChiTietHoaDon.txt");
        DSNV dsnv = new DSNV(30, "nv.dat");
        DSKH dskh = new DSKH(30, "kh.dat");
